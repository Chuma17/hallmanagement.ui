...
const StudentsOverDue = () => {
    ...
    useEffect(() => {
        async function getStudents() {
            ...
            try {
                const { data } = await axios.get(`https://localhost:44324/api/ExitPass/get-students-over-due`,
                    {
                        headers: {
    ...
    return <>
        ...
        <div className="container ms-auto me-auto mt-3">
            <div style={{ borderRadius: "10px" }} className="d-flex justify-content-between bg-dark p-4 text-light">
                ...
                <h3>OVERDUE STUDENTS [ {students.length} ]</h3>
...
export default StudentsOverDue;