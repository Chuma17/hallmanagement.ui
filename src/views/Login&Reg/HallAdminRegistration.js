...
const HallAdminRegistration = () => {
    ...
    async function submitHandler(e) {
        ...
        try {
            const response = await axios.post(`https://localhost:44324/api/HallAdmin/HallAdmin-registration`,
    ...
    useEffect(() => {
        async function getHalls() {
            try {
                const { data } = await axios.get("https://localhost:44324/api/Hall/get-unassigned-halls",
                    {
                        headers: {
                            Authorization: `Bearer ${user.accessToken}`
                        }
...
export default HallAdminRegistration;