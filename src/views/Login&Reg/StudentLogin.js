                                ...
                                <div className="col-md-6 col-lg-7 d-flex align-items-center">
                                    <div className="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form className="form" onSubmit={submitHandler}>
                                            ...
                                            <h5 className="fw-normal mb-3 pb-3 text-center" style={{ letterSpacing: '1px' }}>Student Login</h5>
                                            ...
                                            <p className="mb-2 pb-lg-2 mb-2 text-center">Don't have an account? <Link to="/student-registration">Register here</Link></p>
